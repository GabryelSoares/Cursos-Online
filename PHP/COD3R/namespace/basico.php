...
// Acessa de forma relativa ao namespace atual
// echo contexto\CONSTANTE3 . '<br>'; 

// Acessa de forma absoluta
echo \contexto\CONSTANTE3 . '<br>';
...
// Acessa outro __NAMESPACE__ de forma absoluta
...
// echo \soma(1,2) . '<br>'; //A função soma não está na raiz
